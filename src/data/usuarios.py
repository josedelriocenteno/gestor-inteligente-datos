...
from utils.validaciones import Validaciones  # Asumiendo tienes validaciones.py

@dataclass
class GestorUsuarios:
    """Clase para gestionar usuarios (lista de tuplas)"""
    ...
    def obtener_usuarios(self) -> List[Tuple[int, str, int, str]]:
        """Devuelve lista para estadísticas"""
